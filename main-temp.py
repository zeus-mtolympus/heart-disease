...
from FeatureSelector import AStarFeatureSelectorV2, MutualInfoGreedySelectorV2
...
selector = AStarFeatureSelectorV2().fit(Xbin_train, y_train, bin_feature_names)               
Xsel_train = AStarFeatureSelectorV2().fit(Xbin_train, y_train, bin_feature_names).transform(Xbin_train)
selector.print_log()
