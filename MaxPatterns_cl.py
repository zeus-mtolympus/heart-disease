...
class MaxPatterns:
    ...
    def fit(self, Xsel, y, original_feature_names):
        ...
        rules_raw = []
        # Fix #3: only accumulate label_support for rules that pass the threshold
        label_support = {}

        unique_instances = np.unique(Xn, axis=0)
        ...
        for inst in unique_instances:
            ...
            # Fix #3: only count support for rules that actually pass threshold
